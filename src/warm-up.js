...
// comparison operator.
var shouldOrderMore = true || false;
if (inStock < 20) {
...
if (inStock >= 1) {
  console.log(`I'm going to eat so ${food}!`);
} else {
...
var vegatables = ["zucchini", "squash", "carrots", "bell peppers", "cauliflower"];
...
// different fruits.
var fruits =["apple", "banana", "grapes", "kiwi", "avocado", "mango", "pear"];
